...
pub const STRINGS: &[(&str, &str, &str, &str, &str)] = &[
    ...
    ("codex_status_colors", "Codex status colours", "Codex 状态颜色", "Codex 狀態顏色", "Codex ステータスカラー"),
    ("codex_working_color", "Working", "运行中", "執行中", "実行中"),
    ("codex_working_color_note", "Shown while Codex is processing a turn", "Codex 正在处理任务时显示", "Codex 正在處理工作時顯示", "Codex がターンを処理中に表示"),
    ("codex_attention_color", "Waiting for approval", "等待批准", "等待核准", "承認待ち"),
    ("codex_attention_color_note", "Shown when Codex needs your permission", "Codex 需要你授权时显示", "Codex 需要你授權時顯示", "Codex が許可を求めているときに表示"),
    ("codex_success_color", "Completed", "已完成", "已完成", "完了"),
    ("codex_success_color_note", "Shown briefly after a turn completes", "任务完成后短暂显示", "工作完成後短暫顯示", "ターン完了後に短時間表示"),
    ("codex_error_color", "Error", "出错", "錯誤", "エラー"),
    ("codex_error_color_note", "Shown when a status client reports an error", "状态客户端报告错误时显示", "狀態用戶端回報錯誤時顯示", "ステータスクライアントがエラーを報告したときに表示"),
