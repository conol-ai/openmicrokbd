...
pub const STRINGS: &[(&str, &str, &str, &str, &str)] = &[
    ...
    ("mode", "Mode", "模式", "模式", "モード"),
    ("mouse_pointer_arrow_keys_or", "Mouse pointer, color grading, arrow keys, or custom keys", "鼠标指针、调色、方向键或自定义按键", "滑鼠指標、調色、方向鍵或自訂按鍵", "マウスポインター、カラーグレーディング、矢印キー、カスタムキー"),
    ...
    ("joy_grade_detail", "Deflection drags with the left button auto-held — tuned for DaVinci Resolve's color wheels. Pushing the stick is a left click.", "偏移摇杆时自动按住左键拖动——为 DaVinci Resolve 色轮调校。按下摇杆为左键单击。", "偏移搖桿時自動按住左鍵拖曳——為 DaVinci Resolve 色輪調校。按下搖桿為左鍵點擊。", "スティックを倒すと左ボタンを押したままドラッグ。DaVinci Resolve のカラーホイール向け。押し込みは左クリックです。"),
    ("joy_grade_howto", "In Resolve's color page, park the pointer over a color wheel, then deflect the stick — it grabs the wheel and nudges it like a panel trackball, letting go when the stick returns to center.", "在 Resolve 调色页面，将指针停在色轮上，然后偏移摇杆——它会像调色台轨迹球一样抓住并微调色轮，摇杆回中即松开。", "在 Resolve 調色頁面，將指標停在色輪上，然後偏移搖桿——它會像調色台軌跡球一樣抓住並微調色輪，搖桿回中即鬆開。", "Resolve のカラーページでポインターをカラーホイールに合わせ、スティックを倒すと、パネルのトラックボールのようにホイールを掴んで微調整できます。中央に戻すと離れます。"),
    ...
    ("app_update_badge", "APP UPDATE", "应用更新", "應用程式更新", "アプリ更新"),
    ("app_update_available", "Update available", "有可用更新", "有可用更新", "アップデートがあります"),
    ("app_update_action", "Update…", "更新…", "更新…", "アップデート…"),
    ("app_update_in_progress", "Update in progress…", "正在更新…", "正在更新…", "アップデート中…"),
    ("app_update_download_dmg", "Download DMG", "下载 DMG", "下載 DMG", "DMG をダウンロード"),
    ("app_update_downloading_dmg", "Downloading DMG", "正在下载 DMG", "正在下載 DMG", "DMG をダウンロード中"),
    ("app_update_ready", "Verified DMG ready", "已验证的 DMG 已就绪", "已驗證的 DMG 已就緒", "検証済み DMG の準備完了"),
    ("app_update_open_dmg", "Open DMG", "打开 DMG", "開啟 DMG", "DMG を開く"),
    ("app_update_failed", "Update failed", "更新失败", "更新失敗", "アップデート失敗"),
    ...
    ("drag_speed", "Drag speed", "拖动速度", "拖曳速度", "ドラッグ速度"),
    ...
    ("community", "COMMUNITY", "社区", "社群", "コミュニティ"),
    ("community_note", "CoHDL + OpenMicroKbd", "CoHDL + OpenMicroKbd", "CoHDL + OpenMicroKbd", "CoHDL + OpenMicroKbd"),
    ("join_discord", "Join the Discord", "加入 Discord 社区", "加入 Discord 社群", "Discord に参加"),
    ("discord_open_failed", "COULD NOT OPEN DISCORD", "无法打开 Discord", "無法開啟 Discord", "DISCORD を開けませんでした"),
    ...
    ("agent_status_colors", "Coding-agent status colours", "编程智能体状态颜色", "程式設計代理狀態顏色", "コーディングエージェントのステータスカラー"),
    ("agent_working_color", "Working", "运行中", "執行中", "実行中"),
    ("agent_working_color_note", "Shown while an agent is processing a turn", "智能体正在处理任务时显示", "代理正在處理工作時顯示", "エージェントがターンを処理中に表示"),
    ("agent_attention_color", "Waiting for approval", "等待批准", "等待核准", "承認待ち"),
    ("agent_attention_color_note", "Shown when an agent needs your permission", "智能体需要你授权时显示", "代理需要你授權時顯示", "エージェントが許可を求めているときに表示"),
    ("agent_success_color", "Completed", "已完成", "已完成", "完了"),
    ("agent_success_color_note", "Shown briefly after a turn completes", "任务完成后短暂显示", "工作完成後短暫顯示", "ターン完了後に短時間表示"),
    ("agent_error_color", "Error", "出错", "錯誤", "エラー"),
    ("agent_error_color_note", "Shown when an agent reports an error", "智能体报告错误时显示", "代理回報錯誤時顯示", "エージェントがエラーを報告したときに表示"),
    ("agent_integrations", "Agent integrations", "编程智能体集成", "程式設計代理整合", "エージェント連携"),
    ("agent_integrations_note", "Install user-level status helpers · OpenMicro must be running", "安装用户级状态辅助程序 · OpenMicro 必须保持运行", "安裝使用者層級的狀態輔助程式 · OpenMicro 必須保持執行", "ユーザーレベルのステータス連携をインストール · OpenMicro の起動が必要"),
    ("agent_codex_integration_note", "Review in /hooks after install", "安装后请在 /hooks 中检查", "安裝後請在 /hooks 中檢查", "インストール後に /hooks で確認"),
    ...
    ("integration_conflict", "Needs manual review", "需要手动检查", "需要手動檢查", "手動確認が必要"),
    ("integration_unavailable", "Unavailable", "不可用", "無法使用", "利用不可"),
    ("integration_install", "Install", "安装", "安裝", "インストール"),
    ("integration_reinstall", "Reinstall", "重新安装", "重新安裝", "再インストール"),
    ("integration_install_success", "Integration installed", "集成已安装", "整合已安裝", "連携をインストールしました"),
    ("integration_update_success", "Integration updated", "集成已更新", "整合已更新", "連携を更新しました"),
    ("integration_already_installed", "Integration is already configured", "集成已配置", "整合已設定", "連携は設定済みです"),
    ("integration_install_failed", "Installation failed", "安装失败", "安裝失敗", "インストールに失敗しました"),
    ("integration_backups", "Backups", "备份", "備份", "バックアップ"),
    ("integration_restart_agent", "Restart active agent sessions if status lights do not appear", "如果状态灯未显示，请重启正在运行的智能体会话", "若狀態燈未顯示，請重新啟動目前的代理工作階段", "ステータスライトが表示されない場合は、実行中のエージェントセッションを再起動してください"),
    ...
    ("mb_check_updates", "Check for Updates…", "检查更新…", "檢查更新…", "アップデートを確認…"),
