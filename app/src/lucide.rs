//! The full Lucide icon set, as (name, codepoint) into resources/lucide.ttf.
//!
//! Generated from lucide-static's font/info.json (ISC license). The PRD ships
//! the complete library so any icon can label a key; lookup is by the icon's
//! canonical kebab-case name.

/// Sorted by name — `icon_char` binary-searches it.
pub static ICONS: &[(&str, u32)] = &[
    ...
    ("clock-arrow-left", 59149),
    ("clock-arrow-right", 59150),
    ...
    ("dam", 58886),
    ("database", 57517),
    ("database-arrow-down", 59158),
    ("database-arrow-up", 59159),
    ("database-backup", 58283),
    ("database-check", 59160),
    ("database-minus", 59161),
    ("database-plus", 59162),
    ...
    ("list-plus", 57919),
    ("list-restart", 58450),
    ("list-sort-ascending", 59138),
    ("list-sort-descending", 59139),
    ("list-start", 58081),
    ("list-todo", 58563),
    ("list-tree", 58376),
    ("list-video", 58082),
    ...
    ("rotate-3d", 58090),
    ("rotate-ccw", 57672),
    ("rotate-ccw-clock", 57845),
    ("rotate-ccw-key", 58960),
    ("rotate-ccw-square", 58832),
    ("rotate-cw", 57673),
    ("rotate-cw-fading-clock", 59174),
...
/// The glyph for a Lucide icon name, if it exists.
pub fn icon_char(name: &str) -> Option<char> {
    ICONS
        .binary_search_by(|(n, _)| n.cmp(&name))
        .ok()
        .and_then(|i| char::from_u32(ICONS[i].1))
}
